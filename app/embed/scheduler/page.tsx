...
export default async function SchedulerPage({
  ...
  const config: SchedulerConfig = {
    ...
    garage_door_categories: (settingsMap.garage_door_categories as string[]) ?? DEFAULT_CONFIG.garage_door_categories,
    gate_categories: (settingsMap.gate_categories as string[]) ?? DEFAULT_CONFIG.gate_categories,
    garage_door_issues: (settingsMap.garage_door_issues as string[]) ?? DEFAULT_CONFIG.garage_door_issues,
    gate_issues: (settingsMap.gate_issues as string[]) ?? DEFAULT_CONFIG.gate_issues,
