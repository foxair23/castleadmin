...
export default async function ActionItemsPage() {
  ...
  const [unpaidJobs, uninvoicedJobs, staleEstimates, followUpJobs, overdueCustomers, awaitingSfJob, onlineScheduling, acceptedEstimates, commissionReview, notesResult] =
    await Promise.all([
      getUnpaidJobs(),
      getUninvoicedJobs(),
      getStaleEstimates(),
