...
import { filtersFromParams, getMatchingCustomerIds, laterDate, realServiceDate } from '@/lib/marketing/query'
...
export async function GET(req: NextRequest) {
  ...
  for (const id of pageIds) {
    ...
    contacts.push({
      ...
      last_serviced_date: laterDate(lastServiceMap.get(id) ?? null, realServiceDate(c.last_serviced_date)),
