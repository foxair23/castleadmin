...
export const LEGAL_SECTIONS: LegalSection[] = [
  {
    ...
    body:
      ...
      `generating additional sales for Castle Garage Inc.\n\n` +
  ...
  },
  {
    ...
    body:
      ...
      `•  Customer upgrades or add-ons approved by Castle Garage Inc\n\n` +
      `Castle Garage Inc will make the final determination as to whether a sale qualifies as ` +
  ...
  },
  {
    ...
    body:
      ...
      `•  Castle Garage Inc has received payment from the customer; and\n` +
  ...
  },
  {
    ...
    body:
      ...
      `otherwise reversed or adjusted, Castle Garage Inc may reduce, withhold, or recover the ` +
      `related commission.\n\n` +
  ...
  },
  {
    ...
    body:
      `All commissions are subject to review and approval by Castle Garage Inc management.\n\n` +
      `Castle Garage Inc reserves the right to determine:\n` +
  ...
  },
  {
    ...
    body:
      ...
      `Castle Garage Inc may change, replace, suspend, or discontinue this plan at any time. Future ` +
