...
// login page, and some documents are image scans. Feeding either to the PDF parser produces
// "No PDF header found (line:0 col:2560000 offset=1280000)", which tells the office nothing
// and looks like the feature is broken rather than the file being wrong.
//
// So sniff the magic bytes first and say, in words, what the file is.

export type SniffedType = 'pdf' | 'png' | 'jpeg' | 'gif' | 'tiff' | 'zip' | 'html' | 'json' | 'empty' | 'unknown'
