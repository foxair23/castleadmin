...
const fields = ['baseUrl', 'token', 'receivedBy', 'pollMinutes', 'maxDetailPerRun', 'clopayMaxDetailPerRun', 'clopayInstallerNum', 'clopayEntryUrl', 'genieUser', 'clopayUser', 'sfCompany', 'sfUser', 'castleUser']
