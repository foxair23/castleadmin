          ...
          <div className="order-3 sm:order-2 flex items-center gap-6 w-full sm:w-auto pb-2 sm:py-3 overflow-x-auto">
            {isAdmin ? (
              <>
                ...
                <NavLink href="/admin/leadgen" current={pathname.startsWith('/admin/leadgen')}>LeadGen</NavLink>
                ...
                <NavLink href="/admin/cassie" current={pathname.startsWith('/admin/cassie')}>Cassie</NavLink>
              </>
            ) : (
              <>
                ...
                <NavLink href="/tech/leaderboard" current={pathname.startsWith('/tech/leaderboard')}>Leaderboard</NavLink>
              </>
            )}
          </div>
