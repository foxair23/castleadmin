...
// Read-only reviews list shared by the technician and sales views. Reps can read
// customer feedback; all management (sync/match) stays on the admin Reviews page.
export default async function ReviewsReadOnly() {
